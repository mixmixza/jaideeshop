   ...
   <div class="container">
        <div class="row">
            ...
            <form action="" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control" name="txtSearch1" placeholder="กรอกราคา">
                        </div>
                        <div class="col-md-5">
                            <input type="number" class="form-control" name="txtSearch2" placeholder="กรอกราคา">
                        </div>
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                $sql = "SELECT * FROM product WHERE name LIKE '%$search%' AND price BETWEEN  '$search1%' AND '$search2%'";
